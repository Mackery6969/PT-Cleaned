if ((sprite_index == spr_horsey_win || sprite_index == spr_horsey_lose) && !other.ispeppino && (other.instakillmove || other.state == states.handstandjump || other.state == states.mach2))
{
	var t = other.id;
