var _save = false;
if (key && (obj_player1.state == states.normal || obj_player1.state == states.mach1 || obj_player1.state == states.mach2 || obj_player1.state == states.mach3 || obj_player1.state == states.Sjumpprep) && sprite_index == spr_elevatorlocked && obj_player1.key_up && obj_player1.grounded && place_meeting(x, y, obj_player1))
{
	_save = true;
